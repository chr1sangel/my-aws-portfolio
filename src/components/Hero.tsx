...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="text-center lg:text-left max-w-2xl">
            ...
            <h2 className="text-xl lg:text-2xl text-muted-foreground mb-6">
              IT Coordinator & System Administrator
            </h2>
