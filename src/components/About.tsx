        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-lg border border-border">
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              I'm an IT Coordinator and System Administrator based in <strong className="text-foreground">Skopje, North Macedonia</strong>. 
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              My journey in IT has taken me through diverse roles—from system engineering and network 
              administration to drone operations and product development. This varied experience has 
              equipped me with a unique perspective on solving complex technical challenges and 
              driving innovation in IT environments.
            </p>
